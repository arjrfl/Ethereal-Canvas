...
// 	return (
// 		<div className='font-custom container max-w-6xl mx-auto mt-5 relative -z-50'>
// 			{/* HERO SECTION */}
// 			<div className='md:grid md:grid-cols-3 gap-4 md:px-4 xl:grid-cols-4 mb-5'>
// 				{/* ARTIST CAROUSEL */}
...
// 									<div className='hidden sm:grid sm:grid-cols-2 sm:grid-rows-2 sm:col-span-2 sm:row-span-2 sm:gap-4 order-last rounded-xl'>
// 										<div>
// 											<img
// 												src={artist.recentArtwork?.images?.angleOne}
// 												alt='artwork angle'
...
// 								<img src={image} alt='' className='w-full h-full object-cover aspect-auto' />
// 							</SwiperSlide>
// 						))}
// 					</Swiper>
// 				</div>
...
// 				{/* RANDOM ARTIST */}
// 				<div className='hidden xl:block col-span-1 bg-red-700 rounded-2xl'>
// 					<ul>
// 						<li></li>
// 					</ul>
// 				</div>
				...
				<div className='hidden xl:flex col-span-1 flex-col justify-between rounded-2xl'>
					{randomArtists.map((artist, index) => (
						...
						>
							...
							/>
							<div className='flex flex-col justify-center text-slate-200 backdrop-blur-md'>
								<h3 className='font-semibold'>{artist.fullName}</h3>
								<p className='text-[10px]'>{artist.email}</p>
							</div>
						</div>
					))}
				</div>
