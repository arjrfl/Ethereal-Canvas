...
const CollectorDashboard = () => {
	...
	return (
		<div className='font-custom container max-w-[90rem] mx-auto mt-5 px-4 bg-green-100'>
				...
				<ul className='flex gap-x-10 mb-5'>
					{[
						...
						<li key={index}>
							<Link
								to={item.path}
								className={`text-slate-800 font-semibold px-4 py-2 rounded-lg space-x-2 ${
				...
				<div className='grid grid-cols-6 grid-rows-1 gap-x-3'>
					<div className='col-span-1 bg-white rounded-xl'>
						{userData && userData.data ? (
							<div className='flex flex-col items-center p-6 space-y-1 truncate'>
					...
					<div className='col-span-5 bg-white rounded-xl p-5'>
