						...
						{[
							...
							<li key={medium}>
								<button
									...
									className={`px-4 py-1 border rounded-lg text-white font-medium tracking-wider ${selectedMedium === medium ? 'bg-[#67afda]' : 'bg-cyan-600'}`}
								>
									{medium}
								</button>
							</li>
						...
						{loading ? (
							...
							artworks.map(artwork => (
								...
								>
									...
									<span className='absolute px-3 py-[3px] text-[10px] font-semibold tracking-widest bg-red-600 text-white -top-2 -right-2 rounded'>
										FOR SALE
									</span>
								</div>
							))
