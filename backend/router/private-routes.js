...
router.put('/collector/update-password/:id', authorizeRoles('collector'), collectorChangePassword);
router.put('/collector/remove-favorite', authorizeRoles('collector'), updateFavorites);
